...
static inline void scale2x_8_def_single(scale2x_uint8* MDFN_RESTRICT dst, const scale2x_uint8* MDFN_RESTRICT src0, const scale2x_uint8* MDFN_RESTRICT src1, const scale2x_uint8* MDFN_RESTRICT src2, unsigned count)
{
	assert(count >= 2);
...
static inline void scale2x_16_def_single(scale2x_uint16* MDFN_RESTRICT dst, const scale2x_uint16* MDFN_RESTRICT src0, const scale2x_uint16* MDFN_RESTRICT src1, const scale2x_uint16* MDFN_RESTRICT src2, unsigned count)
{
	assert(count >= 2);
...
static inline void scale2x_32_def_single(scale2x_uint32* MDFN_RESTRICT dst, const scale2x_uint32* MDFN_RESTRICT src0, const scale2x_uint32* MDFN_RESTRICT src1, const scale2x_uint32* MDFN_RESTRICT src2, unsigned count)
{
	assert(count >= 2);
