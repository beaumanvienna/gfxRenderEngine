...
void MDVDP::Run(void)
{
    ...
    */
    ...
    EVT_exit:;
    #else
        switch(vdp_line_phase)
        {
            case EVT_END_OF_ACTIVE:
                vdp_hcounter_start_ts = md_timestamp + vdp_cycle_counter;
            ...
            case EVT_LEFT_BORDER:
                status &= ~0x0004;	// Clear h-blank flag
                break;

            case EVT_REMAINING_AD:
                break;
